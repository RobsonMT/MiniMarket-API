...
from app.exceptions import WrongKeyError, InvalidCellphone, CellphoneAlrealyExists, EmailAlrealyExists
...
def validate_user_data_svc(data, Model):
    ...
    if 'contact' in data_keys and not re.search('\(..\).....\-....$', data["contact"]) or len(data["contact"]) != 14:
